...
const int VERTICES2 = 24;	// Total Number of Vertices
const int INDICES2 = 12;	// Total Number of Indexes
const int UVS2 = 48;		// Total Number of UVs
const int COLORS2 = 24;		// Total Number of Colors
